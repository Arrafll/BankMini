    ...
    <div class="col-md-10 content">
        <div class="panel panel-default">
            <div class="panel-heading">
                Pembayaran Biaya Kunjungan Industri
            </div>
            <div class="panel-body">

                <div class="btn-group" style="margin-bottom:2%;">
                    <a type="button" href="<?= base_url() ?>/Ki/Export_excel2/Semua%20Tahun%20Ajaran" class=" btn btn-success" style="height:35px;">Excel</a>
                    <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" style="height:35px;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="caret"></span> <span class="sr-only">Toggle Dropdown</span>
                    </button>
                    <div class="dropdown-menu">
                        <?php foreach ($tahun as $t) { ?>
                            <a style="margin-left:10px;color:black;" href="<?= base_url() ?>/Ki/Export_excel2/<?= $t['tahun']; ?>">Tahun Ajaran <?= $t['tahun']; ?></a>
                        <?php } ?>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($siswa as $s) { ?>
                            <tr>
                                ...
                                <td><?= $s['ket_ki']; ?></td>
                                <?php if ($s['ket_ki'] == 'Belum Lunas') { ?>


                                    <td><a href="<?= base_url() ?>Ki/ki_bayar/<?= $s['id_siswa']; ?>" class="btn btn-primary">Bayar</a></td>

                                <?php    } ?>
                                <?php if ($s['ket_ki'] == 'Lunas') { ?>
                                    <td></td>
                                <?php } ?>
