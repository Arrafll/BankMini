                                ...
                                <div id="dropdown-lvl2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="<?= base_url('Ki'); ?>">Pembayaran Kunjungan Industri</a></li>
    ...
    <div class="col-md-8 content" style="margin-left:auto; margin-right:auto;">
        <div class="panel panel-default">
            <div class="panel-heading">
                Pembayaran Biaya Kunjungan Industri - <?= $ki['nama']; ?>
            </div>

            <div class="panel-body">
                <form action="<?= base_url('Ki/bayar'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Sisa Cicilan</td>
                                <td>:</td>
                                <td>Rp. <?= number_format($ki['bayar_ki'], 0, ",", "."); ?>,-</td>
                            </tr>
                        </table>
                        <input type="hidden" name="petugas" value="<?= $user['name']; ?>">
                        <input type="hidden" name="tahun" value="<?= $ki['date']; ?>">
                        <input type="hidden" class="form-control" id="Nama" placeholder="Masukkan username" name="nama" value="<?= $ki['nama']; ?>" readonly>
                        <input type="hidden" class="form-control" id="nominal" placeholder="Masukkan username" name="total" value="<?= $ki['bayar_ki']; ?>" readonly>
                        <input type="hidden" class="form-control" id="Nisn" placeholder="Masukkan username" name="nisn" value="<?= $ki['nisn']; ?>" readonly>
                    </div>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input type="hidden" class="form-control" id="Nama" placeholder="Masukkan username" name="id_siswa" value="<?= $ki['id_siswa']; ?>" readonly>
                <div class="form-group">
                    <label for="rupiah">Masukkan nominal</label>
                    <input type="text" autocomplete="off" min="0" step="any" class="form-control" id="rupiah" placeholder="Masukkan nominal" name="nominal" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="<?= base_url('ki'); ?>" class="btn btn-danger">&nbsp;Batal&nbsp;</a>
                </div>
                </form>
            </div>
        </div>
...
<script>
    function openWindowReload(link) {
        setTimeout(function() {
            window.location.href = "<?= base_url(); ?>/Ki/redirect/<?= $ki['id_siswa']; ?>"
