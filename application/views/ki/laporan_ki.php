                                ...
                                <div id="dropdown-lvl3" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="<?= base_url('Ki/laporan_ki'); ?>">Laporan Bayaran KI</a></li>
    ...
    <div class="col-md-10 content">
        <div class="panel panel-default">
            <div class="panel-heading">
                Laporan Pembayaran Kunjungan Industri
            </div>
            <div class="panel-body">
                <?= $this->session->flashdata('message'); ?>
                <a href="<?php echo base_url('Ki/Export_excel') ?>" style="margin-bottom:30px;margin-left:10px;" class="btn btn-success" style="margin:10px;">Excel</a>
                    ...
                    <tbody>
                        <?php foreach ($laporan as $s) { ?>
                            <tr>
                                ...
                                <td>Rp. <?= number_format($s['cicilan'], 0, ",", "."); ?>,-</td>
                                <td><?= $s['petugas']; ?></td>
                                <td><a href="<?= base_url() ?>Ki/ki_hapus_laporan/<?= $s['id']; ?>" class="btn btn-danger">Hapus</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
