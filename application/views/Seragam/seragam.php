        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="btn-group" style="margin-bottom:2%;">
                    <a type="button" href="<?= base_url() ?>/Seragam/Export_excel2/Semua%20Tahun%20Ajaran" class=" btn btn-success" style="height:35px;">Excel</a>
                    ...
                    <div class="dropdown-menu">
                        <?php foreach ($tahun as $t) { ?>
                            <a style="margin-left:10px;color:black;" href="<?= base_url() ?>/Seragam/Export_excel2/<?= $t['tahun']; ?>">Tahun Ajaran <?= $t['tahun']; ?></a>
                        <?php } ?>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($siswa as $s) { ?>
                            <tr>
                                ...
                                <td><?= $s['ket_seragam']; ?></td>
                                <?php if ($s['ket_seragam'] == 'Belum Lunas') { ?>
                                    <td><a href="<?= base_url() ?>Seragam/seragam_bayar/<?= $s['id_siswa']; ?>" class="btn btn-primary">Bayar</a></td>
                                <?php } ?>
                                <?php if ($s['ket_seragam'] == 'Lunas') { ?>
                                    <td></td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
