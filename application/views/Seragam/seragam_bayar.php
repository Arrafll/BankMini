                                ...
                                <div id="dropdown-lvl2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="<?= base_url('Seragam'); ?>">Pembayaran Seragam</a></li>
    ...
    <div class="col-md-8 content" style="margin-left:auto; margin-right:auto;">
        <div class="panel panel-default">
            <div class="panel-heading">
                Pembayaran Seragam - <?= $seragam['nama']; ?>
            </div>

            <div class="panel-body">
                <form action="<?= base_url('Seragam/bayar'); ?>" method="POST">

                    <div class="form-group">
                        <table>
                            <tr>
                                <td style="width:120px;">Nisn</td>
                            ...
                            <tr>
                                ...
                                <td>Sisa Cicilan</td>
                                <td>:</td>
                                <td>Rp . <?= number_format($seragam['bayar_seragam'], 0, ",", "."); ?>,-</td>
                            </tr>
                        </table>
                        <input type="hidden" name="petugas" value="<?= $user['name']; ?>">
                        <input type="hidden" name="tahun" value="<?= $seragam['date']; ?>">
                        <input type="hidden" class="form-control" id="Nama" placeholder="Masukkan username" name="nama" value="<?= $seragam['nama']; ?>" readonly>
                        <input type="hidden" class="form-control" id="nominal" placeholder="Masukkan username" name="total" value="<?= $seragam['bayar_seragam']; ?>" readonly>
                        <input type="hidden" class="form-control" id="Nisn" placeholder="Masukkan username" name="nisn" value="<?= $seragam['nisn']; ?>" readonly>
                    </div>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input type="hidden" class="form-control" id="Nama" placeholder="Masukkan username" name="id_siswa" value="<?= $seragam['id_siswa']; ?>" readonly>
                <div class="form-group">
                    <label for="rupiah">Masukkan nominal</label>
                    <input type="text" min="0" class="form-control" id="rupiah" placeholder="Masukkan nominal" autocomplete="off" name="nominal" required>
                </div>


                <div class="form-group">
                    <button type="submit" class="btn btn-primary" formtarget="_blank" onClick="openWindowReload(this)">Bayar</button>
                    <a href="<?= base_url('Seragam'); ?>" class="btn btn-danger">&nbsp;Batal&nbsp;</a>
                </div>
                </form>
            </div>
        </div>
...
<script>
    function openWindowReload(link) {
        setTimeout(function() {
            window.location.href = "<?= base_url(); ?>/Seragam/redirect/<?= $seragam['id_siswa']; ?>"
