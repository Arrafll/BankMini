                                ...
                                <div id="dropdown-lvl3" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="<?= base_url('Seragam/laporan_seragam'); ?>">Laporan Bayaran Seragam</a></li>
    ...
    <div class="col-md-10 content">
        <div class="panel panel-default">
            <div class="panel-heading">
                Laporan Pembayaran Seragam
            </div>
            <div class="panel-body">
                <?= $this->session->flashdata('message'); ?>
                <a href="<?php echo base_url('Seragam/Export_excel') ?>" style="margin-bottom:30px;margin-left:10px;" class="btn btn-success" style="margin:10px;">Excel</a>
                    ...
                    <tbody>
                        <?php foreach ($laporan as $s) { ?>
                            <tr>
                                ...
                                <td>Rp. <?= $s['cicilan']; ?>,-</td>
                                <td><?= $s['petugas']; ?></td>
                                <td><a href="<?= base_url() ?>Seragam/hapus_laporan/<?= $s['id']; ?>" class="btn btn-danger">Hapus</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
