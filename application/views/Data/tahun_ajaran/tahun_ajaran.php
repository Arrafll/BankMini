...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Data/TahunAjaran/tambah'); ?>" method="POST">
                    <div class="form-group">
                        <label for="saldo">
                            Tahun Ajaran
                        </label>
                        <input type="number" class="form-control" id="saldo" placeholder="Masukkan tahun ajaran" name="tahun">
                    </div>
                                ...
                                <div id="dropdown-lvl1" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li class="active"><a href="#">Tahun Ajaran</a></li>
    ...
    <div class="col-md-10 content">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="" data-toggle="modal" data-target="#tambah" class="btn btn-primary" style="margin-bottom:30px;">Tambah</a>
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($tahun as $s) { ?>
                            <tr>
                                <td><?= $no; ?></td>
                                <td><?= $s['tahun']; ?>/<?= $s['tahun'] + 1; ?></td>
                                <td>
                                    <div class="col text-center">
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $s['id']; ?>">
                                            Hapus
                                        </button>
                                        <!-- Modal -->

                                    </div>
                                    <div class="modal fade" id="hapus<?= $s['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                ...
                                                <div class="modal-body">
                                                    <p>Anda yakin ingin menghapus tahun ajaran <?= $s['tahun']; ?>/<?= $s['tahun'] + 1; ?> ?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="<?= base_url('Data/TahunAjaran/hapus/') . $s['id']; ?>" method="post">
