                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="side-menu-container">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="" data-toggle="modal" data-target="#Logout"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
    ...
    <div class="col-md-8 content" style="margin-left:auto; margin-right:auto;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= form_open_multipart('Data/Data_siswa/tambah'); ?>
                <div class="form-group">
                    <label for="nisn">
                        Nisn
                    </label>
                    <input type="text" class="form-control" id="nisn" autocomplete="off" placeholder="Masukkan Nisn" name="nisn" value="<?= set_value('nisn'); ?>">
                ...
                <div class=" form-group">
                    ...
                    <input type="text" class="form-control" id="nama" autocomplete="off" placeholder="Masukkan nama" name="nama" value="<?= set_value('name'); ?>">
                ...
                <div class=" form-group">
                    ...
                    <select style="padding:3px;padding-left:10px;" type="date" class="form-control" id="date" name="date">
                        <option value="">Pilih Tahun Ajaran</option>
                        <?php foreach ($tahun as $thn) { ?>
                            <option value="<?= $thn['tahun']; ?>"><?= $thn['tahun']; ?>/<?= $thn['tahun'] + 1; ?></option>
                        <?php  } ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <a href="<?= base_url('Data/Data_siswa'); ?>" class="btn btn-danger">&nbsp;Batal&nbsp;</a>
                </div>
                <?= form_close(); ?>
            </div>
        </div>
