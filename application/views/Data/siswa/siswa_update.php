            ...
            <form action="" method="post">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nisn" autocomplete="off" placeholder="Masukkan Nisn" name="nisn" value="<?= $siswa['nisn']; ?>">
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" class="form-control" id="nama" autocomplete="off" placeholder="Masukkan nama" name="nama" value="<?= $siswa['nama']; ?>">
                    ...
                    <div class=" form-group">
                        ...
                        <select class="form-control" id="date" name="date" value="<?= $siswa['date']; ?>">
                            <option value="">Pilih Tahun Ajaran </option>
                            <?php foreach ($tahun as $d) {  ?>
                                <?php if ($d['tahun'] === $siswa['date']) : ?>


                                    <option value="<?= $d['tahun']; ?>" selected><?= $d['tahun']; ?>/<?= $d['tahun'] + 1; ?></option>


                                <?php else : ?>
                                    <option value="<?= $d['tahun']; ?>"><?= $d['tahun']; ?>/<?= $d['tahun'] + 1; ?></option>
