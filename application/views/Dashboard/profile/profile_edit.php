    ...
    <div class="col-md-8 content" style="margin-left:auto; margin-right:auto;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input type="hidden" class="form-control" id="usr" placeholder="Masukkan username" name="username" value="<?= $user['username']; ?>" required>
                ...
                <div class=" form-group">
                    ...
                    <input type="text" class="form-control" id="usr" placeholder="Masukkan nama" name="name" value="<?= $user['name']; ?>" required>
                    <?= form_error('name', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>


                <label for=" output">Ubah Foto Profile</label>
                <div class="form-group">

                    <img id="output" style="width:100px; height:100px; margin-top:10px; margin-bottom:10px;" src="<?php echo base_url('vendor/images/profile/') . $user['image']; ?>" />
