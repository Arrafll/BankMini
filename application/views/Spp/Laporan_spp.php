                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="panel panel-default" id="dropdown">
                                ...
                                <div id="dropdown-lvl3" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li class="active"><a href="<?= base_url('Spp/laporan_spp'); ?>">Laporan Bayaran Spp</a></li>
    ...
    <div class="col-md-10 content">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="<?php echo base_url('Spp/Export_excel') ?>" style="margin-bottom:30px;margin-left:10px;" class="btn btn-success" style="margin:10px;">Excel</a>
                    ...
                    <tbody>
                        <?php foreach ($laporan as $s) { ?>
                            <tr>
                                ...
                                <td><?= ucfirst($s['bulan']); ?> <?= $s['tahun'];  ?>/<?= $s['tahun'] + 1;  ?></td>
                                <td><?= $s['keterangan']; ?></td>
                                <td><?= $s['petugas']; ?></td>
                                <td><a href="<?= base_url() ?>Spp/spp_hapus_laporan/<?= $s['id']; ?>" class="btn btn-danger">Hapus</a></td>
